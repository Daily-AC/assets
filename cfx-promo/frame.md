...
description: >
  ...
  display + EB Garamond body + JetBrains Mono for the index/code voice on a warm-navy code surface,
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "EB Garamond", cqw: 1.5, weight: 400, lineHeight: 1.5 }
  lead:    { fontFamily: "EB Garamond", cqw: 2.08, weight: 400, lineHeight: 1.5 }
  card-title:{ fontFamily: "EB Garamond", cqw: 2.3, weight: 500, lineHeight: 1.25, tracking: "-0.005em" }
  button:  { fontFamily: "EB Garamond", cqw: 1.46, weight: 500, lineHeight: 1.0 }
  tag-upper:{ fontFamily: "EB Garamond", cqw: 1.35, weight: 500, tracking: "0.18em", upper: true }
...
components:
  ...
  pull-quote:
    ...
    description: "A commit message, a reviewer line, or the thesis. EB Garamond italic, small EB Garamond uppercase cite beneath."
  section-rule:
...
its **italic** is the expressive register. **EB Garamond** carries body, leads, card titles, buttons, and
...
- **EB Garamond** (sentence case, negative-tracked) for all display; **EB Garamond** body/chrome; **JetBrains Mono** index + code.
...
- **Type** — EB Garamond sentence-case display (negative-tracked); EB Garamond 400 body; JetBrains Mono kickers (uppercase 0.16em, coral ✱) + code.
...
Two ramps. The **reading/chrome ramp** (EB Garamond `body` 1.5cqw / `lead` 2.08cqw weight 400; JetBrains
...
- **EB Garamond display is sentence case** (NOT title case, NOT uppercase), weight 400, negative-tracked (−0.012..−0.028em); reach for **italic** when the line is a stance or a definition. **EB Garamond body** sentence case weight 400. **JetBrains Mono** kickers UPPERCASE 0.16em with the coral ✱. No uppercase serif, no sans headline, no serif label.
...
**Ground** `{colors.cream}`. **Composes** kicker-spike, pull-quote, tag-upper cite. **Focal** a EB Garamond **italic** `quote-pull` — a commit message, a reviewer line, or the thesis — with a small EB Garamond uppercase cite (author · role) beneath. **Chrome** mono kicker. **Accent** none, or one coral mark. **Fixed** EB Garamond italic quote + uppercase cite. **Free** quote, attribution, layout + density. **Density** free.
...
- Set all display in **EB Garamond, sentence case**, negative-tracked; **EB Garamond 400** body; **JetBrains Mono** kickers (uppercase, 0.16em, coral ✱) + code.
...
- **Type** — EB Garamond sentence-case display (negative-tracked); EB Garamond 400 body; JetBrains Mono kickers (uppercase 0.16em, coral ✱) + code; ≥1.4cqw floor.
